  ...
  const mutation = useMutation(
    async (loginDetails) => {
      return await axios.post(
        ...
        'https://companymicroservice.azurewebsites.net/api/login',
        loginDetails
      )
        .catch((err) => {
    ...
    },
    {
      onSuccess: async (data) => {
        ...
        if (response.error) {
          toast.error('login details dont match', {
            position: "top-right",
            autoClose: 5000,
            ...
            <form className='' onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className="checkboxContainer">
                <div className="d-flex">
                  <input name="acceptTerms" type="checkbox" defaultChecked {...register('acceptTerms')} id="acceptTerms" className={`form-check-input ${errors.acceptTerms ? 'is-invalid' : ''}`} />
                  <span className="checkmark"></span>
                  <label htmlFor="acceptTerms" className="form-check-label termsText">Remember me</label>
                  {/* <label htmlFor="acceptTerms" className="form-check-label termsText">Forgot password?</label> */}
                </div>
              ...
              <div className="inputContainer ">
                <Signup className='mt-4' type="submit">
                  {
                    mutation.isLoading ? (<Spinner animation="border" variant="light" />) : ('Login')
                  }
